...
public class PrefsLogic {
    ...
    private static final String MEDIA_CODECS_EXRTA_SETTINGS_KEY = "codecs_extra_settings";
        ...
        switch (t) {
            case TYPE_MEDIA: {
                ...
                if(!pfw.isAdvancedUser()) {
                    ...
                    pfh.hidePreference(MEDIA_AUDIO_QUALITY_KEY, SipConfigManager.SND_CLOCK_RATE);
                    ...
                    pfh.hidePreference(null, SipConfigManager.CODECS_PER_BANDWIDTH);
                    ...
                    pfh.hidePreference(MEDIA_MISC_KEY, SipConfigManager.AUTO_DETECT_SPEAKER);
                    
                    pfh.hidePreference(null, SipConfigManager.MEDIA_THREAD_COUNT);
                    pfh.hidePreference(null, MEDIA_CODECS_EXRTA_SETTINGS_KEY);
    ...
    //                    }
            ...
            case TYPE_NETWORK: {
                ...
                if(!pfw.isAdvancedUser()) {
                    ...
                    //隱藏整個"傳輸"設定
                    pfh.hidePreference(null, NWK_TRANSPORT_KEY);
                    ...
                    //pfh.hidePreference(NWK_TRANSPORT_KEY, NWK_SIP_PROTOCOL_KEY);
            ...
            case TYPE_UI: {
                ...
                if(!pfw.isAdvancedUser()) {
                    ...
                    pfh.hidePreference("general_ui", SipConfigManager.DTMF_PRESS_TONE_MODE);
                    pfh.hidePreference("general_ui", SipConfigManager.START_WITH_TEXT_DIALER);
                    pfh.hidePreference("general_ui", SipConfigManager.UNLOCKER_TYPE);
                    pfh.hidePreference("general_ui", SipConfigManager.PREVENT_SCREEN_ROTATION);
