...
*/            
			...
			WIZARDS_DICT.put("EZCallPostpay", new WizardInfo("EZCallPostpay", "EZCall Postpay",
					R.drawable.ic_wizard_ezcall, 2, 
					new Locale[] {}, true, false,
					EZCallPostpay.class));
			
			WIZARDS_DICT.put("EZCall070", new WizardInfo("EZCall070", "EZCall 070",
					R.drawable.ic_wizard_ezcall, 1, 
					new Locale[] {}, true, false,
					EZCall070.class));
 		}
		initDone = true;
