...
public class SipProfile implements Parcelable {
    ...
    /**
    * ezcall_reg_code for the wizard internal use.
    *
    * @see String
    */
    public static final String FIELD_EZCALL_REG_CODE = "ezcall_reg_code";
    ...
    /**
    * @see #FIELD_EZCALL_REG_CODE
    */
    public String ezcall_reg_code = null;
    ...
    private SipProfile(Parcel in) {
        ...
        ezcall_reg_code = getReadParcelableString(in.readString());
    ...
    public void writeToParcel(Parcel dest, int flags) {
        ...
        dest.writeString(getWriteParcelableString(ezcall_reg_code));
    ...
    private final void createFromContentValue(ContentValues args) {
        ...
        tmp_s = args.getAsString(FIELD_EZCALL_REG_CODE);
        if (tmp_s != null) {
          ezcall_reg_code = tmp_s;
        }
    ...
    public ContentValues getDbContentValues() {
        ...
        args.put(FIELD_EZCALL_REG_CODE, ezcall_reg_code);
